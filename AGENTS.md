...
Do not offer or use the brainstorming visual companion by default. Only offer or use it when the user explicitly asks for a browser-based visual companion, mockup preview, or visual comparison.
