...
class MoviesDetailHero extends StatelessWidget {
  const MoviesDetailHero({super.key, required this.detail});
  ...
  Widget build(BuildContext context) {
    ...
    final hours = detail.durationMinutes ~/ 60;
    final minutes = detail.durationMinutes % 60;
    final durationLabel =
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            '$durationLabel  |  ${detail.year}  |  ${detail.ageRating}',
            style: const TextStyle(
